...
export const AccountSettings = ({ opened, setOpened, userId }: Props) => {
    ...
    /**
     * queryResult -> contatins the result of the query. For example isLoading, data, error, etc.
  ...
  const { saveButtonProps, formProps, queryResult } = useForm<
    ...
    HttpError,
    // A third type parameter used to specify the type of variables for the UpdateUserMutation. Meaning that the variables for the UpdateUserMutation should be of type UpdateMutationVariables
  ...
  >({
    ...
    resource: "users",
    /**
     * specify the action that should be performed on the resource. Behind the scenes, Refine calls useOne hook to thet the data of the user for edit action.
     * https://refine.dev/docs/data/hooks/use-form/#edit
     */
    action: "edit",
    id: userId,
    /**
     * used to provide additional information to the data provider.
  ...
  const closeModal = () => {
    ...
    // if query is processing, show loading indicator
