...
// Fro demo purposes and to make it easier to test the app, you can use the following credentials

export const authCredentials = {
    email: "michael.scott@dundermifflin.com",
    password: "love_dwight_schrut"
};
...
export const authProvider: AuthBindings = {
    ...
    login: async ({ email }) => {
        ...
        try {
            ...
            // this will call dataProvider which will go through the fetchWrapper fundtion
            ...
            const { data } = await dataProvider.custom({
                ...
                meta: {
                    variables: { email },
                    // pass the email to see if the user exists and if do, return the accessToken
                    rawQuery: `
